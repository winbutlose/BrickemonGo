...
namespace BrickemonGo
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine(pokedex.GetName("typhlosion"));
            Console.WriteLine(pokedex.GetNum("typhlosion"));
            Console.WriteLine(pokedex.GetType("typhlosion"));
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[0]);
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[1]);
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[2]);
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[3]);
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[4]);
            Console.WriteLine(pokedex.GetBaseStats("typhlosion")[5]); 
            Console.WriteLine(String.Join("\n", pokedex.GetAbilities("typhlosion")));
            Console.WriteLine("[{0}]", string.Join(", ", pokedex.GetOtherFormes("typhlosion")));
            Console.WriteLine("[{0}]", string.Join(", ", pokedex.GetOtherFormes("arceus")));
            Console.WriteLine(pokedex.GetPrevo("typhlosion"));
            Console.WriteLine(String.Join("\n", pokedex.GetEvos("eevee")));
            Utils.InitTypeChart();
            //Utils.printTypeChart();
            Random rand = new Random();
            Application.EnableVisualStyles();
            Application.SetCompatibleTextRenderingDefault(false);
            //Application.Run(new PokedexViewer());
            //Console.WriteLine(x);
            //x.GiveExp(1000000);
