...
namespace BrickemonGo
{
    public class Nature
    {
            ...
            public Nature(int x) //creates specific nature with given id
            {
                GenerateNatureSpecific(x);
            }
            ...
            public void GenerateNatureSpecific(int x)
            { //generate a nature with id = x
                id = x;
        ...
        public String GetBoostedStatString()
        {
            switch (boostedStat)
            {
                case 1:
        ...
        public String GetReducedStatString()
        {
            switch (reducedStat)
            {
                case 1:
